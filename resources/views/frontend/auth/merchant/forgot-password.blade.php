	...
	<div class="auth-page d-flex align-items-center justify-content-center">
		<div class="login-card rounded shadow p-4">
			...
			<div class="text-center mb-4">
				...
				<h5 class="text-success mb-2">{{ __('Merchant Password Reset') }}</h5>
				<p class="text-muted mb-0">
					@lang("Enter the email address linked to your merchant account, and we'll email you a link to reset your password.")
				</p>
                <div class="mt-2 mb-3">
				...
				<div class="mb-3">
					...
					<span class="input-group-text">
						...
						<input
							...
							name="email"
							class="form-control"
							placeholder="@lang('Enter your business email')"
							required
							autocomplete="email"
						>
					</div>
            ...
            <div class="border-top mt-4 pt-3">
                <p class="text-center mb-0 sm-mb-text">
                    {{ __("Need to reset a regular user account password?") }}
                    <a href="{{ route('user.password.request') }}" class="text-decoration-none text-primary fw-semibold">
                        <i class="fa-duotone fa-user me-1"></i> {{ __('User Password Reset') }}
                    </a>
                </p>
            </div>
		</div>
