        ...
        <div class="login-card rounded shadow p-4">
            <div class="text-center mb-4">
                ...
                @if (Session::has('success'))
                    <div class="mt-2 mb-3">
                        <span class="badge bg-success p-2" style="color: white !important; background: #e6513e !important;">
            ...
            <form action="{{ route('merchant.login') }}" method="post">
                ...
                <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <a href="{{ route('merchant.password.request') }}"
                        class="text-decoration-none text-primary fw-semibold sm-mb-text">
                        {{ __('Forgot Password') }}?
                    </a>
                </div>
