    ...
    function X(t, s) {
        ...
        if (n.language) {
            ...
            if (
                ...
                c = a.language = e;
                const t = h || r[I];
                (h = Object.assign({ format: P, weekStart: R }, r[I])),
                    c !== I && Object.assign(h, r[c]),
                    (a.locale = h),
                    o === t.format && (o = a.format = h.format),
                    D === t.weekStart &&
                    ((D = a.weekStart = h.weekStart),
                        (a.weekEnd = J(h.weekStart)));
            }
        }
        if (n.format) {
        ...
        let v = g;
        void 0 !== n.pickLevel && ((v = z(n.pickLevel, 2)), delete n.pickLevel),
            v !== g &&
            (v > g &&
        ...
        if (void 0 !== n.minDate) {
            const e = l(0, 0, 1);
            (b = null === n.minDate ? e : U(n.minDate, o, h, b)),
                b !== e && (b = w(b, g, !1)),
                delete n.minDate;
        }
        if (
            (void 0 !== n.maxDate &&
                ((k = null === n.maxDate ? void 0 : U(n.maxDate, o, h, k)),
                    void 0 !== k && (k = w(k, g, !0)),
                    delete n.maxDate),
                k < b
        ...
        if (void 0 !== n.weekStart) {
            ...
            isNaN(e) || ((D = a.weekStart = e), (a.weekEnd = J(e))),
                delete n.weekStart;
        }
        if (
        ...
        let x = f;
        void 0 !== n.maxView && ((x = z(n.maxView, f)), delete n.maxView),
            (x = g > x ? g : x),
            x !== f && (f = a.maxView = x);
        let M = m;
        if (
            (void 0 !== n.startView &&
                ((M = z(n.startView, M)), delete n.startView),
                M < g ? (M = g) : M > f && (M = f),
                M !== m && (a.startView = M),
                n.prevArrow)
        ) {
    ...
    class te extends ee {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek &&
                (t.showDaysOfWeek
                    ? (B(this.dow),
                        this.calendarWeeks && B(this.calendarWeeks.dow))
                    : (L(this.dow),
    ...
    function We(e, t, i) {
        ...
        (d || r) &&
            (d && d.toString() !== e.dates.toString()
                ? ((e.dates = d), Ae(e, n ? 3 : 1), ae(e, "changeDate"))
                : Ae(e, 1),
                a && e.hide());
    }
    return class {
